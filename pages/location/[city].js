...
import TodaysWeather from "../../components/Weather.TodaysWeather.jsx";
...
export async function getServerSideProps(context) {
    ...
    const res = await fetch(
        `https://api.openweathermap.org/data/2.5/onecall?lat=${city.coord.lat}&lon=${city.coord.lon}&appid=${process.env.NEXT_PUBLIC_WEATHER_API_KEY}&units=metric&exclude=minutely`
    );
